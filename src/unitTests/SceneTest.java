...
class SceneTest {
	...
	public void testConstructor() {
		Scene _scene = new Scene("myScene");
		_scene.set_camera(new Camera(Point3D.ZERO, new Vector(0, 1, 0), new Vector(0, 0, 1)));
		
		assertEquals(0, _scene.get_camera().get_upVector().dotProduct(_scene.get_camera().get_toVector()),0 );
		assertEquals(0, _scene.get_camera().getRightVector().dotProduct(_scene.get_camera().get_toVector()),0 );
		assertEquals(0, _scene.get_camera().getRightVector().dotProduct(_scene.get_camera().get_upVector()),0 );
	}
	
	@Test
	public void  testConstructRayThroughPixel() {
		Scene _scene1 = new Scene("myScene1");
		_scene1.set_camera(new Camera(Point3D.ZERO, new Vector(0, 1, 0), new Vector(0, 0, 1)));

		// 3X3
		Ray ray11 = _scene1.get_camera().constructRayThroughPixel(3, 3, 1, 1, 100, 150, 150);
		...
		Ray ray33 = _scene1.get_camera().constructRayThroughPixel(3, 3, 3, 3, 100, 150, 150);
		...
		Ray ray21 = _scene1.get_camera().constructRayThroughPixel(3, 3, 2, 1, 100, 150, 150);
		...
		Ray ray23 = _scene1.get_camera().constructRayThroughPixel(3, 3, 2, 3, 100, 150, 150);
		...
		Ray ray12 = _scene1.get_camera().constructRayThroughPixel(3, 3, 1, 2, 100, 150, 150);
		...
		Ray ray32 = _scene1.get_camera().constructRayThroughPixel(3, 3, 3, 2, 100, 150, 150);
		...
		Ray ray22 = _scene1.get_camera().constructRayThroughPixel(3, 3, 2, 2, 100, 150, 150);
		...
		Ray rayS22 = _scene1.get_camera().constructRayThroughPixel(4, 3, 2, 2, 100, 200, 150);
		...
		Ray rayS32 = _scene1.get_camera().constructRayThroughPixel(4, 3, 3, 2, 100, 200, 150);
		...
		Ray rayS11 = _scene1.get_camera().constructRayThroughPixel(4, 3, 1, 1, 100, 200, 150);
		...
		Ray rayS43 = _scene1.get_camera().constructRayThroughPixel(4, 3, 4, 3, 100, 200, 150);
		...
		Ray ray_c22 = _scene1.get_camera().constructRayThroughPixel(3, 4, 2, 2, 100, 150, 200);
		...
		Ray ray_c32 = _scene1.get_camera().constructRayThroughPixel(3, 4, 3, 2, 100, 150, 200);
		...
		Ray ray_c11 = _scene1.get_camera().constructRayThroughPixel(3, 4, 1, 1, 100, 150, 200);
		...
		Ray ray_c43 = _scene1.get_camera().constructRayThroughPixel(3, 4, 3, 4, 100, 150, 200);
		...
		Scene _scene2 = new Scene("myScene2");
		_scene2.set_camera(new Camera(Point3D.ZERO, new Vector(0, -1, 0), new Vector(0, 0, -1)));
		
		// 3X3
		Ray ray1 = _scene2.get_camera().constructRayThroughPixel(3, 3, 3, 3, 100, 150, 150);
		...
		// 3X3
		Ray ray_d11 = _scene2.get_camera().constructRayThroughPixel(3, 3, 1, 1, 100, 150, 150);
		...
		Ray ray_d33 = _scene2.get_camera().constructRayThroughPixel(3, 3, 3, 3, 100, 150, 150);
		...
		Ray ray_d21 = _scene2.get_camera().constructRayThroughPixel(3, 3, 2, 1, 100, 150, 150);
		...
		Ray ray_d23 = _scene2.get_camera().constructRayThroughPixel(3, 3, 2, 3, 100, 150, 150);
		...
		Ray ray_d12 = _scene2.get_camera().constructRayThroughPixel(3, 3, 1, 2, 100, 150, 150);
		...
		Ray ray_d32 = _scene2.get_camera().constructRayThroughPixel(3, 3, 3, 2, 100, 150, 150);
		...
		Scene _scene3 = new Scene("myScene3");
		_scene3.set_camera(new Camera(Point3D.ZERO, new Vector(0, 1, 0), new Vector(0, 0, -1)));
		
		// 3X4
		Ray ray_e22 = _scene3.get_camera().constructRayThroughPixel(4, 3, 2, 2, 100, 200, 150);
		...
		Ray ray_e32 = _scene3.get_camera().constructRayThroughPixel(4, 3, 3, 2, 100, 200, 150);
		...
		Ray ray_e11 = _scene3.get_camera().constructRayThroughPixel(4, 3, 1, 1, 100, 200, 150);
		...
		Ray ray_e43 = _scene3.get_camera().constructRayThroughPixel(4, 3, 4, 3, 100, 200, 150);
		...
		// -----------------------
		Scene _scene4 = new Scene("myScene4");
		_scene4.set_camera(new Camera(Point3D.ZERO, new Vector(0, 1, 0), new Vector(0, 0, 1)));
		Ray littl33 = _scene4.get_camera().constructRayThroughPixel(3, 3, 3, 3, 10, 6, 6);
		Ray checklittl33 = new Ray(Point3D.ZERO, new Vector(-2, -2, 10).normalize());
		Ray littl11 = _scene4.get_camera().constructRayThroughPixel(3, 3, 1, 1, 10, 6, 6);
